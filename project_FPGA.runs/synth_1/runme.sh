...
HD_PWD='C:/Users/Altium-3/Documents/Thibo_Amine/project_FPGA/project_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_up.vds -m64 -mode batch -messageDb vivado.pb -notrace -source test_up.tcl
