...
HD_PWD='C:/Users/Altium7/Desktop/MCU-on-Basys3-master/MCU-on-Basys3-master/project_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_up.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_up.tcl -notrace
