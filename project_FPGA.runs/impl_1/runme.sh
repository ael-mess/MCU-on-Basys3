...
HD_PWD='C:/Users/Altium-3/Documents/Thibo_Amine/project_FPGA/project_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_up.vdi -applog -m64 -messageDb vivado.pb -mode batch -source test_up.tcl -notrace
